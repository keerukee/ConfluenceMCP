...
public static class ConfluenceTools
{
        ...
        [McpParameter("Body format: storage, atlas_doc_format, view, export_view (default: storage)", required: false)] string bodyFormat = "storage")
    {
        try
        {
            ...
            var response = ConfluenceClient.GetAsync($"content/{pageId}?expand={expand}").GetAwaiter().GetResult();
    ...
    public static string GetPageByTitle(
        ...
        [McpParameter("The page title")] string title)
    {
        try
        {
            ...
            var response = ConfluenceClient.GetAsync($"content?spaceKey={spaceKey}&title={encodedTitle}&expand=body.storage,version,space,ancestors").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("Content type: page or blogpost (default: page)", required: false)] string contentType = "page")
    {
        try
        {
            ...
            var response = ConfluenceClient.PostAsync("content", pageData).GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("Version message/comment (optional)", required: false)] string? versionMessage = null)
    {
        try
        {
            ...
            var response = ConfluenceClient.PutAsync($"content/{pageId}", pageData).GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("Purge permanently (true) or move to trash (false, default)", required: false)] bool purge = false)
    {
        try
        {
            ...
            ConfluenceClient.DeleteAsync(endpoint).GetAwaiter().GetResult();
    ...
    public static string GetPageChildren(
        ...
        [McpParameter("Start index for pagination (default: 0)", required: false)] int start = 0)
    {
        try
        {
            var response = ConfluenceClient.GetAsync($"content/{pageId}/child/page?limit={limit}&start={start}&expand=version").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
    ...
    public static string GetPageAncestors(
        [McpParameter("The page ID")] string pageId)
    {
        try
        {
            var response = ConfluenceClient.GetAsync($"content/{pageId}?expand=ancestors").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("Maximum results (default: 25)", required: false)] int limit = 25)
    {
        try
        {
            var response = ConfluenceClient.GetAsync($"content/{pageId}/history?expand=lastUpdated,previousVersion,contributors&limit={limit}").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("The version number")] int versionNumber)
    {
        try
        {
            var response = ConfluenceClient.GetAsync($"content/{pageId}?status=historical&version={versionNumber}&expand=body.storage,version").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("Parent page ID in destination (optional)", required: false)] string? parentId = null)
    {
        try
        {
            ...
            var sourcePage = ConfluenceClient.GetAsync($"content/{sourcePageId}?expand=body.storage").GetAwaiter().GetResult();
        ...
        [McpParameter("New parent page ID")] string newParentId)
    {
        try
        {
            ...
            var currentPage = ConfluenceClient.GetAsync($"content/{pageId}?expand=version,body.storage").GetAwaiter().GetResult();
    ...
    public static string ListSpaces(
        ...
        [McpParameter("Start index for pagination (default: 0)", required: false)] int start = 0)
    {
        try
        {
            ...
            var response = ConfluenceClient.GetAsync(endpoint).GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("The space key")] string spaceKey)
    {
        try
        {
            var response = ConfluenceClient.GetAsync($"space/{spaceKey}?expand=description.plain,homepage,metadata.labels").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("Space type: global or personal (default: global)", required: false)] string type = "global")
    {
        try
        {
            ...
            var response = ConfluenceClient.PostAsync("space", spaceData).GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("The space key to delete")] string spaceKey)
    {
        try
        {
            ConfluenceClient.DeleteAsync($"space/{spaceKey}").GetAwaiter().GetResult();
    ...
    public static string GetSpaceContent(
        [McpParameter("The space key")] string spaceKey,
        ...
        [McpParameter("Include content excerpt in results (default: true)", required: false)] bool includeExcerpt = true)
    {
        try
        {
            ...
            var response = ConfluenceClient.GetAsync($"search?cql={encodedCql}&limit={limit}&start={start}&expand={expand}").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("Maximum results (default: 25)", required: false)] int limit = 25)
    {
        try
        {
            ...
            var response = ConfluenceClient.GetAsync($"search?cql={encodedCql}&limit={limit}&expand=content.space,excerpt").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("Maximum results (default: 25)", required: false)] int limit = 25)
    {
        try
        {
            ...
            var response = ConfluenceClient.GetAsync($"search?cql={encodedCql}&limit={limit}&expand=content.space,content.metadata.labels").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
    ...
    public static string GetPageComments(
        [McpParameter("The page ID")] string pageId,
        ...
        [McpParameter("Maximum results (default: 25)", required: false)] int limit = 25)
    {
        try
        {
            var response = ConfluenceClient.GetAsync($"content/{pageId}/child/comment?depth={depth}&limit={limit}&expand=body.storage,version").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("Parent comment ID for replies (optional)", required: false)] string? parentCommentId = null)
    {
        try
        {
            ...
            var response = ConfluenceClient.PostAsync("content", commentData).GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("The comment ID to delete")] string commentId)
    {
        try
        {
            ConfluenceClient.DeleteAsync($"content/{commentId}").GetAwaiter().GetResult();
        ...
        [McpParameter("Maximum results (default: 25)", required: false)] int limit = 25)
    {
        try
        {
            var response = ConfluenceClient.GetAsync($"content/{pageId}/child/attachment?limit={limit}&expand=version,metadata.mediaType").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
    ...
    public static string GetAttachmentInfo(
        [McpParameter("The attachment ID")] string attachmentId)
    {
        try
        {
            var response = ConfluenceClient.GetAsync($"content/{attachmentId}?expand=version,container,metadata.mediaType").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("The attachment ID to delete")] string attachmentId)
    {
        try
        {
            ConfluenceClient.DeleteAsync($"content/{attachmentId}").GetAwaiter().GetResult();
        ...
        [McpParameter("The page ID")] string pageId)
    {
        try
        {
            var response = ConfluenceClient.GetAsync($"content/{pageId}/label").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("Comma-separated label names to add")] string labels)
    {
        try
        {
            ...
            var response = ConfluenceClient.PostAsync($"content/{pageId}/label", labelArray).GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("Label name to remove")] string label)
    {
        try
        {
            ConfluenceClient.DeleteAsync($"content/{pageId}/label/{label.ToLowerInvariant()}").GetAwaiter().GetResult();
    ...
    public static string GetCurrentUser()
    {
        try
        {
            var response = ConfluenceClient.GetAsync("user/current").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("Maximum results (default: 25)", required: false)] int limit = 25)
    {
        try
        {
            ...
            var encodedCql = HttpUtility.UrlEncode(cql);
            var response = ConfluenceClient.GetAsync($"search/user?cql={encodedCql}&limit={limit}").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("Maximum results (default: 25)", required: false)] int limit = 25)
    {
        try
        {
            ...
            var encodedCql = HttpUtility.UrlEncode(cql);
            var response = ConfluenceClient.GetAsync($"search?cql={encodedCql}&limit={limit}&expand=content.space").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("The blog post content in storage format")] string content)
    {
        try
        {
            ...
            var response = ConfluenceClient.PostAsync("content", blogData).GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("Maximum results (default: 25)", required: false)] int limit = 25)
    {
        try
        {
            var response = ConfluenceClient.GetAsync($"space/{spaceKey}/content/blogpost?limit={limit}&expand=version,body.storage").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
    ...
    public static string CreatePageFromTemplate(
        [McpParameter("The space key")] string spaceKey,
        [McpParameter("The page title")] string title,
        ...
        [McpParameter("Parent page ID (optional)", required: false)] string? parentId = null)
    {
        try
        {
            ...
            var templateResponse = ConfluenceClient.GetAsync($"template/{templateId}?expand=body").GetAwaiter().GetResult();
    ...
    public static string GetPageRestrictions(
        [McpParameter("The page ID")] string pageId)
    {
        try
        {
            var response = ConfluenceClient.GetAsync($"content/{pageId}/restriction").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
    ...
    public static string GetSpacePermissions(
        [McpParameter("The space key")] string spaceKey)
    {
        try
        {
            var response = ConfluenceClient.GetAsync($"space/{spaceKey}?expand=permissions").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
    ...
    public static string WatchPage(
        [McpParameter("The page ID to watch")] string pageId)
    {
        try
        {
            var currentUser = ConfluenceClient.GetAsync("user/current").GetAwaiter().GetResult();
            var userJson = JsonNode.Parse(currentUser);
            var username = userJson?["username"]?.GetValue<string>() ?? "";

            ConfluenceClient.PostAsync($"user/watch/content/{pageId}", new { }).GetAwaiter().GetResult();
    ...
    public static string UnwatchPage(
        [McpParameter("The page ID to unwatch")] string pageId)
    {
        try
        {
            ConfluenceClient.DeleteAsync($"user/watch/content/{pageId}").GetAwaiter().GetResult();
    ...
    public static string WatchSpace(
        [McpParameter("The space key to watch")] string spaceKey)
    {
        try
        {
            ConfluenceClient.PostAsync($"user/watch/space/{spaceKey}", new { }).GetAwaiter().GetResult();
    ...
    public static string GetContentProperties(
        [McpParameter("The page ID")] string pageId)
    {
        try
        {
            var response = ConfluenceClient.GetAsync($"content/{pageId}/property").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
    ...
    public static string SetContentProperty(
        [McpParameter("The page ID")] string pageId,
        ...
        [McpParameter("Property value (JSON string)")] string value)
    {
        try
        {
            ...
            var response = ConfluenceClient.PostAsync($"content/{pageId}/property", propertyData).GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
        ...
        [McpParameter("Maximum results (default: 25)", required: false)] int limit = 25)
    {
        try
        {
            ...
            var response = ConfluenceClient.GetAsync($"search?cql={encodedCql}&limit={limit}&expand=content.space,content.version").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
    ...
    public static string GetMyRecentWork(
        [McpParameter("Maximum results (default: 25)", required: false)] int limit = 25)
    {
        try
        {
    ...
    public static string GetServerInfo()
    {
        try
        {
            var response = ConfluenceClient.GetAsync("settings/lookandfeel").GetAwaiter().GetResult();
            return ConfluenceClient.FormatJsonResponse(response);
        }
        catch (Exception ex)
        {
